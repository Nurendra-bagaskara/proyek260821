...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        if($insert){
            echo "<script>alert('Sukses menambahkan produk');location.href='tambah_petugas.php';</script>";
        } else {
            echo "<script>alert('Gagal menambahkan produk');location.href='tambah_petugas.php';</script>";
